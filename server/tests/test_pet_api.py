...
class TestPetAPI:
    ...
    def test_create_pet_success(self, client, sample_owner, sample_pet_data):
    ...
    def test_create_pet_invalid_type_breed(self, client, sample_owner):
    ...
    def test_create_pet_invalid_data(self, client, sample_owner):
    ...
    def test_get_pet_by_id_success(self, client, sample_pet):
        """Test successful pet retrieval by ID."""
        response = client.get(f"/api/pets/{sample_pet.id}")
    ...
    def test_get_pet_by_id_not_found(self, client):
        ...
        response = client.get("/api/pets/non-existent-id")
        
        assert response.status_code == status.HTTP_404_NOT_FOUND
        assert "not found" in response.json()["detail"]
    
    def test_get_pet_by_pet_id_success(self, client, sample_pet):
        """Test successful pet retrieval by pet_id."""
        response = client.get(f"/api/pets/pet-id/{sample_pet.pet_id}")
    ...
    def test_get_pet_by_pet_id_not_found(self, client):
        """Test pet retrieval by non-existent pet_id."""
        response = client.get("/api/pets/pet-id/DOG-INVALID-000000")
        
        assert response.status_code == status.HTTP_404_NOT_FOUND
        assert "not found" in response.json()["detail"]
    
    def test_get_pets_by_owner_success(self, client, sample_pet, sample_owner):
        """Test successful retrieval of pets by owner."""
        response = client.get(f"/api/pets/owner/{sample_owner.id}")
    ...
    def test_get_pets_by_owner_pagination(self, client, sample_pet, sample_owner):
        """Test pet retrieval by owner with pagination."""
        response = client.get(f"/api/pets/owner/{sample_owner.id}?skip=0&limit=1")
        
        assert response.status_code == status.HTTP_200_OK
        data = response.json()
        assert len(data["pets"]) <= 1
    
    def test_update_pet_success(self, client, sample_pet):
        ...
        response = client.patch(f"/api/pets/{sample_pet.id}", json=update_data)
    ...
    def test_update_pet_not_found(self, client):
        ...
        response = client.patch("/api/pets/non-existent-id", json=update_data)
        
        assert response.status_code == status.HTTP_404_NOT_FOUND
        assert "not found" in response.json()["detail"]
    
    def test_delete_pet_success(self, client, sample_pet):
        """Test successful pet deletion (soft delete)."""
        response = client.delete(f"/api/pets/{sample_pet.id}")
        
        assert response.status_code == status.HTTP_204_NO_CONTENT
    
    def test_delete_pet_not_found(self, client):
        """Test pet deletion with non-existent ID."""
        response = client.delete("/api/pets/non-existent-id")
        
        assert response.status_code == status.HTTP_404_NOT_FOUND
        assert "not found" in response.json()["detail"]
    
    def test_search_pets_success(self, client, sample_pet):
        """Test successful pet search."""
        response = client.get(f"/api/pets/search/?q={sample_pet.name}")
    ...
    def test_search_pets_by_breed(self, client, sample_pet):
        """Test pet search by breed."""
        response = client.get(f"/api/pets/search/?q={sample_pet.breed}")
    ...
    def test_search_pets_no_results(self, client):
        """Test pet search with no results."""
        response = client.get("/api/pets/search/?q=nonexistent")
    ...
    def test_get_pets_by_type_success(self, client, sample_pet):
        """Test successful retrieval of pets by type."""
        response = client.get(f"/api/pets/type/{sample_pet.pet_type}")
    ...
    def test_get_pets_by_breed_success(self, client, sample_pet):
        """Test successful retrieval of pets by breed."""
        response = client.get(f"/api/pets/breed/{sample_pet.breed}")
